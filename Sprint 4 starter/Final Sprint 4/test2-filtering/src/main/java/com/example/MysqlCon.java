...
class MysqlCon{
    ...
    public void getStudentNumbers() {
        ...
        try {
            ...
            /**for(int i=0;i<studentNumberList.size();i++){
                ...
                if(i>=3 && i<6){
                    studentNumberList2.add(studentNumberList.get(i));

                }
                if(i>= 6 && i<9){
                    studentNumberList3.add(studentNumberList.get(i));

                }
                if(i>= 9 && i<12){
                    studentNumberList4.add(studentNumberList.get(i));

                }
                if(i>= 12 && i<15){
                    studentNumberList5.add(studentNumberList.get(i));
    ...
    public List<students> getStudentObjects(int pageNumber){
        ...
        if(pageNumber == 2){
            currStudentNumberList = studentNumberList2;
        }
        if(pageNumber == 3){
            currStudentNumberList = studentNumberList3;
        }
        if(pageNumber == 4){
            currStudentNumberList = studentNumberList4;
        }
        if(pageNumber == 5){
