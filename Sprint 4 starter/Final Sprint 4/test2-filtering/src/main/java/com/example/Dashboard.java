    ...
    public Dashboard(){
        ...
        btnUpload.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent clickEvent) {
                ...
                getUI().getNavigator().navigateTo("uploadpage");
            }
        });
...
//highlighting ui
       ...
       contentLayout1.addComponent(currpg);
        ...
        goToPage.addClickListener(e->{
            ...
            if (pageNumbers.getValue() != null) {currPage  = Integer.parseInt(gotoNum);}
    ...
    private void HardFiltering(Button.ClickEvent clickEvent) {
        ...
        if (value.equals("")) {
            value = "EMPTY";
        } else{ensurefieldsnotblank = true;}
        System.out.println(value);
        FilterList.add(value);
